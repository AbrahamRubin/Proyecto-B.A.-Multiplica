...
var metScroll = {
	...
	moverse: function (e) {
		...
		// Le Restamos el tamaño del menu para que corta el scroll seccion.
			...
			if ( propScroll.posicion < propScroll.seccion_distancia) {
				...
				if (propScroll.posicion <= propScroll.seccion_distancia) {
					clearInterval(propScroll.intervalo);
			            ...
			            //scrollTo (eje X, eje  Y) EN este caso hicimos una funcion para averiguar la posición ---> window.scrollTo te lleva a la posición que pongas en los parametros    
